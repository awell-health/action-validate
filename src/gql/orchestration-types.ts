...
export type CreatePatientMutation = { __typename?: 'Mutation', createPatient: { __typename?: 'CreatePatientPayload', code: string, success: boolean, patient?: { __typename?: 'User', id: string, tenant_id: string, profile?: { __typename?: 'UserProfile', last_name?: string | null } | null } | null } };
...
export type DeletePathwayMutation = { __typename?: 'Mutation', deletePathway: { __typename?: 'EmptyPayload', code: string, success: boolean } };
...
export type DeletePatientMutation = { __typename?: 'Mutation', deletePatient: { __typename?: 'EmptyPayload', code: string, success: boolean } };
...
export type FormQuery = { __typename?: 'Query', form: { __typename?: 'FormPayload', code: string, success: boolean, form?: { __typename?: 'Form', id: string, key: string, title: string, questions: Array<{ __typename?: 'Question', id: string, key: string }> } | null } };
...
export type PathwayActivitiesQuery = { __typename?: 'Query', pathwayActivities: { __typename?: 'ActivitiesPayload', code: string, success: boolean, activities: Array<{ __typename?: 'Activity', id: string, stream_id: string, date: string, action: ActivityAction, status: ActivityStatus, resolution?: ActivityResolution | null, reference_id: string, container_name?: string | null, isUserActivity: boolean, public?: boolean | null, session_id?: string | null, icon_url?: string | null, form_display_mode?: FormDisplayMode | null, object: { __typename?: 'ActivityObject', type: ActivityObjectType, id: string, name: string, email?: string | null, preferred_language?: string | null }, indirect_object?: { __typename?: 'ActivityObject', type: ActivityObjectType, id: string, name: string, email?: string | null, preferred_language?: string | null } | null, form?: { __typename?: 'Form', questions: Array<{ __typename?: 'Question', key: string, id: string, definition_id: string, title: string, dataPointValueType?: DataPointValueType | null, questionType?: QuestionType | null, userQuestionType?: UserQuestionType | null, metadata?: string | null }> } | null }> } };
...
export type StartPathwayMutation = { __typename?: 'Mutation', startPathway: { __typename?: 'StartPathwayPayload', code: string, success: boolean, pathway_id: string } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreatePatient(variables?: CreatePatientMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreatePatientMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreatePatientMutation>(CreatePatientDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreatePatient', 'mutation', variables);
    },
    DeletePathway(variables: DeletePathwayMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeletePathwayMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeletePathwayMutation>(DeletePathwayDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeletePathway', 'mutation', variables);
    },
    DeletePatient(variables: DeletePatientMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeletePatientMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeletePatientMutation>(DeletePatientDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeletePatient', 'mutation', variables);
    },
    ...
    PathwayActivities(variables: PathwayActivitiesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<PathwayActivitiesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PathwayActivitiesQuery>(PathwayActivitiesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'PathwayActivities', 'query', variables);
    },
    StartPathway(variables: StartPathwayMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<StartPathwayMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<StartPathwayMutation>(StartPathwayDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'StartPathway', 'mutation', variables);
    },
