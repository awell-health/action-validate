...
export type DataPointCollectedActivationReference =
...
export type CreatePathwayCaseMutation = {
  ...
  createPathwayCase: {
    ...
    pathway_case: {
      ...
      pathway_id: string
      title: string
      last_modification_date?: any | null
      start_date?: any | null
      status: PathwayCaseStatus
    }
  }
...
export function getSdk(
  ...
  return {
    CreatePathwayCase(
      variables: CreatePathwayCaseMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<CreatePathwayCaseMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<CreatePathwayCaseMutation>(
            CreatePathwayCaseDocument,
            variables,
    ...
    DeletePathwayCase(
      variables: DeletePathwayCaseMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<DeletePathwayCaseMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DeletePathwayCaseMutation>(
            DeletePathwayCaseDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'DeletePathwayCase',
    ...
    Form(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<FormQuery>(FormDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'Form',
    ...
    PathwayCase(
      variables: PathwayCaseQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<PathwayCaseQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<PathwayCaseQuery>(PathwayCaseDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'PathwayCase',
    ...
    PathwayCaseActivities(
      variables: PathwayCaseActivitiesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<PathwayCaseActivitiesQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<PathwayCaseActivitiesQuery>(
            PathwayCaseActivitiesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'PathwayCaseActivities',
    ...
    PathwayCases(
      variables: PathwayCasesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<PathwayCasesQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<PathwayCasesQuery>(PathwayCasesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'PathwayCases',
    ...
    ResetPreview(
      variables: ResetPreviewMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ResetPreviewMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<ResetPreviewMutation>(
    ...
    StartPreview(
      variables: StartPreviewMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<StartPreviewMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<StartPreviewMutation>(
            StartPreviewDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'StartPreview',
    ...
    SubmitChecklist(
      variables: SubmitChecklistMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<SubmitChecklistMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<SubmitChecklistMutation>(
    ...
    SubmitFormResponse(
      variables: SubmitFormResponseMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<SubmitFormResponseMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<SubmitFormResponseMutation>(
